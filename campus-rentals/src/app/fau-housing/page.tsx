...
export default function FAUHousingPage() {
  const features = [
    {
      ...
      title: "Prime FAU Location",
      description: "Walking distance to Florida Atlantic University main campus"
    },
    {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-white">
      ...
      <div className="relative w-full min-h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 flex flex-col justify-center items-center py-20 px-4 text-center max-w-4xl mx-auto">
          ...
          <p className="text-2xl text-gray-200 mb-8 max-w-3xl">
            Premium student housing designed specifically for Florida Atlantic University students
          </p>
      ...
      {/* Why Choose FAU Housing Section */}
      ...
      {/* FAU Properties Section */}
      <section id="properties" className="py-20">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold mb-12 text-center bg-gradient-to-r from-yellow-400 to-green-400 bg-clip-text text-transparent">
            FAU Student Properties
          </h2>
      ...
      <section className="py-20 bg-gray-800/50 backdrop-blur-sm">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h3 className="text-2xl font-bold mb-6 text-yellow-400">Perfect for FAU Students</h3>
              <ul className="space-y-4">
                ...
                <li className="flex items-start">
                  <StarIcon className="w-6 h-6 text-yellow-400 mr-3 mt-1 flex-shrink-0" />
                  <span className="text-gray-300">Easy access to FAU's recreation center and dining halls</span>
                </li>
                <li className="flex items-start">
                  <StarIcon className="w-6 h-6 text-yellow-400 mr-3 mt-1 flex-shrink-0" />
                  <span className="text-gray-300">Close to FAU's research facilities and labs</span>
                </li>
                <li className="flex items-start">
                  <StarIcon className="w-6 h-6 text-yellow-400 mr-3 mt-1 flex-shrink-0" />
                  <span className="text-gray-300">Convenient access to FAU's shuttle services</span>
                </li>
                <li className="flex items-start">
                  <StarIcon className="w-6 h-6 text-yellow-400 mr-3 mt-1 flex-shrink-0" />
                  <span className="text-gray-300">Near FAU's sports facilities and events</span>
                </li>
              </ul>
            </div>
            <div className="bg-gray-900/50 p-8 rounded-xl backdrop-blur-sm">
              <h4 className="text-xl font-bold mb-4 text-green-400">FAU Student Discounts</h4>
              <p className="text-gray-300 mb-4">
                Special rates and incentives available for FAU students, including:
              </p>
              <ul className="space-y-2 text-gray-300">
                <li>• Reduced security deposits for FAU students</li>
                <li>• Flexible lease terms aligned with academic calendar</li>
                <li>• Free move-in assistance</li>
                <li>• Access to FAU student events and activities</li>
                <li>• Priority placement for returning FAU students</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-6 bg-gradient-to-r from-yellow-400 to-green-400 bg-clip-text text-transparent">
            Ready to Find Your FAU Home?
          </h2>
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Join hundreds of FAU students who have found their perfect off-campus housing with us.
          </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center">
            <p className="text-gray-400 mb-2">
              Premium Housing for FAU Students
            </p>
