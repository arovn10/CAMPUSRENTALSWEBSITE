  ...
  return (
    <div className="max-w-2xl mx-auto py-12">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <button type="submit" className="px-6 py-2 bg-accent-deep text-white rounded-lg hover:bg-[#336E73] transition-colors duration-300 font-medium">Create Property</button>
      </form>
    </div>
  );
} 