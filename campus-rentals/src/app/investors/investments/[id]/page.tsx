                      ...
                      <div key={owner.id} className="p-4 bg-gray-50 rounded-lg">
                        ...
                        <div className="mb-3">
                          ...
                          <select
                            ...
                            required={!owner.user.firstName || !owner.user.lastName || !owner.user.email}
                          >
                          ...
                          <p className="text-xs text-gray-500 mt-1">
                            Choose from existing investors or create a new one below
                          </p>
                          {/* Validation Status */}
                          {owner.userId || (owner.user.firstName && owner.user.lastName && owner.user.email) ? (
                            ...
                            <p className="text-xs text-red-600 mt-1">
                              ⚠ Please select an existing investor or fill in all new investor details
                            </p>
                          )}
                        </div>
