...
export default function TulaneHousingClient() {
  ...
  const faqStructuredData = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'What is the best area for off campus housing near Tulane?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'The Uptown area near Tulane University is the most popular choice for off campus housing. Our properties are located within walking distance of the campus, close to Audubon Park, and in safe, student-friendly neighborhoods.',
        },
      },
      {
        '@type': 'Question',
        name: 'How far are your off campus apartments from Tulane?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Most of our properties are within 0.5 miles of the Tulane University campus, making them easily walkable or bikeable. This proximity saves you time and money on transportation while keeping you close to campus life.',
        },
      },
      {
        '@type': 'Question',
        name: 'Are your off campus rentals near Tulane furnished?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Yes! All our off campus housing properties near Tulane come fully furnished with modern furniture, appliances, and everything you need for comfortable student living. Just bring your personal items and move in.',
        },
      },
      {
        '@type': 'Question',
        name: 'Do you offer group housing for students attending Tulane?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Absolutely! We have spacious houses perfect for groups of friends or roommates. Our group housing options make it easy to live with your friends while attending school in the Tulane area.',
        },
      },
    ],
  };
