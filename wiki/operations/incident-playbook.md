...
- **Follow-ups:** consider alerting when `/api/properties` serves fallback data (e.g. flag in payload + health-monitor check); consider making the site fail loud (empty state) instead of rendering fake listings.
